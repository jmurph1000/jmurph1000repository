...
async function ensureRoles(userId: string, roles: RoleType[]) {
...
async function ensureCapabilities(userId: string, entries: Array<{ category: PaymentCategory; type: CapabilityType }>) {
